	...
	const router = createBrowserRouter(
		createRoutesFromElements(
			<>
				...
				<Route element={<ProtectedRoute isAuth={isAuth} isloading={isLoading} nav={<Navbar />} footer={<Footer />} userRoute={true} isAdmin={isAdmin} />}>
				...
				{/* //admin route  */}
				<Route element={<ProtectedRoute isAuth={isAuth} isloading={isLoading} nav={<AdminNav />} footer={<AdminFooter />} adminRoute={true} isAdmin={isAdmin} />}>
